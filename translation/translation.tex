...
\begin{document}
    ...
    $\left(a_{j}^{\left(i\right)},
     ...
     \begin{tikzpicture}[line width=0.7pt, line cap=round]
         ...
         \draw[blue] (4, 0) arc[start angle=180, end angle=0, x radius=\rxone, y radius=\ryone];
         \draw[blue] (5, 0) arc[start angle=180, end angle=0, x radius=\rxone, y radius=\ryone];
         \draw[blue] (0, 0) arc[start angle=180, end angle=0, x radius=\rxsix, y radius=\rysix];

         \draw[orange] (3, 0) arc[start angle=180, end angle=0, x radius=\rxtwopoint, y radius=\rytwopoint];
         \draw[orange] (5.5, 0) arc[start angle=180, end angle=0, x radius=\rxone, y radius=\ryone];
         ...
         \begin{itemize}
            ...
            \end{equation*} 
             ...
             \begin{tikzpicture}[line width=0.7pt, line cap=round]
                 ...
                 \node[font=\scriptsize] at (2.5, -0.3) {$a^{\left(2, 1\right)}$};
