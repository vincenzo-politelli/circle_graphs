...
\begin{document}
    ...
    \begin{proof}
        ...
        connected. \todo{if $G\left(F\right)$ was
        ...
        of $F$ with the properties
        required by the present lemma.
        \todo{this is because $F^{0}\left(a_2\right)
        = \left\{h_1\right\}$ and
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            \item The intervals in
                ...
                \todo{Otherwise $\omega\left(F\right)
                \geq 3$}
                \label{cond:2}
        ...
        \todo{This is true for intervals
